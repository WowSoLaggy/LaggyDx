...
namespace Dx
{
  ...
  public:
    ...
    virtual std::shared_ptr<ICollider> getCollider() const override;
    virtual void setCollider(std::shared_ptr<ICollider> i_collider) override;
  ...
  private:
    ...
    std::shared_ptr<ICollider> d_collider;
