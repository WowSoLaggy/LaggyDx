...
namespace Dx
{
  Shape3d::Shape3d(std::vector<VertexPos3NormText> i_verts, std::vector<int> i_inds)
  {
  ...
  const std::vector<VertexPos3NormText>& Shape3d::getVerts() const { return d_verts; }
  const std::vector<int>& Shape3d::getInds() const { return d_inds; }

  void Shape3d::setVerts(std::vector<VertexPos3NormText> i_verts)
  {
